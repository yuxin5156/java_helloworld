...
public class MybatisTest {
	 ...
	 */
	@Test
	public void updateStuent() throws IOException {

		StudentModel stu = new StudentModel();
		stu.setStudent_id(8);
		stu.setName("张飞fei");
		SqlSession sqlSession = SqlSessionFactoryUtils.getSqlSessionFactory().openSession();
		sqlSession.update("student.updateStudent", stu);
	...
	public void RemoveStuent() throws IOException {
		...
		SqlSession sqlSession = SqlSessionFactoryUtils.getSqlSessionFactory().openSession(true);//这里设置为true，则会自动提交
